...
const styles = StyleSheet.create({
    slide: {
        width,        flex: 1,    },
    overlay: {        flex: 1,        justifyContent: 'space-between',        paddingHorizontal: wp(6),
        paddingTop: hp(8),
        paddingBottom: hp(18),    },    content: {        alignItems: 'center',    },

    title: {        color: '#FFF',        fontSize: wp(5),        textAlign: 'center',        fontFamily: 'Poppins_600SemiBold',    },    description: {        marginTop: hp(2),        color: '#FFF',
        textAlign: 'center',
        fontSize: wp(3),        lineHeight: 24,        paddingHorizontal: wp(5),        fontFamily: 'Poppins_400Regular',
    },    bottomContainer: {        position: 'absolute',        bottom: hp(5),        left: wp(6),
        right: wp(6),
    },
    dotsContainer: {        flexDirection: 'row',        justifyContent: 'center',        marginBottom: hp(3),
    },    dot: {        height: 10,        borderRadius: 5,        backgroundColor: COLORS?.primary,
        marginHorizontal: 4,    },    button: {        backgroundColor: COLORS?.primary,        paddingVertical: hp(2),        borderRadius: wp(10),        alignItems: 'center',    },

    buttonText: {        color: '#FFF',        fontSize: wp(4.4),        fontFamily: 'Poppins_600SemiBold',
    },});
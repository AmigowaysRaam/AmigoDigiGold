...
export default function QuickSavingsScreen() {
    ...
    return (
        <SafeAreaProvider>
            <SafeAreaView style={styles.container} edges={['top']}>
                <PriceHeader title="Quick Savings" />
...
const styles = StyleSheet.create({
    ...
    card: {
        backgroundColor: '#FFF', borderRadius: 18, padding: wp(5), elevation: 3,
    },
    ...
    infoText: {
        marginTop: hp(1), color: '#666', fontSize: wp(3),
        fontFamily: 'Poppins_500Medium',
    },
    quickTitle: {
        marginTop: hp(3),
